...
<head>
    ...
    .card input::placeholder {
        color: black;
        /* Placeholder color for input fields inside the card */
    }
    </style>
                ...
                <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
                    ...
                    <div class="content flex-row-fluid" id="kt_content">
                        ...
                        <div class="card mb-5 mb-xl-10">
                            <div style="background-color: cadetblue" class="card-header border-0 cursor-pointer"
                                role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details"
                                aria-expanded="true" aria-controls="kt_account_profile_details">
                                <div class="card-title m-0">
                                    <h3 class="fw-bold m-0" style="color: whitesmoke; text-align: center">Registration
                                        Form</h3>
                                </div>
                            </div>
                            ...
                            <div id="kt_account_settings_profile_details" class="collapse show">
                                <form id="kt_account_profile_details_form" class="form"
                                    action="https://www.csbmc.edu.bd/student-admissions" method="POST"
                                    enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="DMrBuT7eXgPySieMVBnuZkP3R3cflEJFLDmqWog6">
                                    <input type="hidden" name="_token" value="DMrBuT7eXgPySieMVBnuZkP3R3cflEJFLDmqWog6">
                                    <div class="card-body border-top p-9">
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <select name="group_id" id="group_id" aria-label="Select a Group"
                                        ...
                                        <div class="row mb-6">
                                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">SSC Roll
                                                Number</label>
                                            <div class="col-lg-8 fv-row">
                                        ...
                                        <div class="row mb-6">
                                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">Nick
                                                Name(UPPERCASE) For
                                                Nameplate</label>
                                            <div class="col-lg-8 fv-row">
                                                <input type="text" name="nick_name" id="nick_name"
                                                    class="form-control form-control-lg form-control-solid"
                                                    placeholder="Nick Name" value="" />
                                                <br>
                                        ...
                                        <div class="row mb-6">
                                            <label
                                                class="col-lg-4 col-form-label required fw-semibold fs-6">Nationality</label>
                                            <div class="col-lg-8 fv-row">
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <select name="gender" id="gender" aria-label="Select a Gender"
                                        ...
                                        <div class="row mb-6">
                                            <label class="col-lg-4 col-form-label  fw-semibold fs-6">Present
                                                Address</label>
                                            <div class="col-lg-8 fv-row">
                                        ...
                                        <div class="row mb-6">
                                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Permanent
                                                Address</label>
                                            <div class="col-lg-8 fv-row">
                                        ...
                                        <div class="row mb-6">
                                            <label class="col-lg-4 col-form-label  fw-semibold fs-6">Name And
                                                Relationship Of
                                                Guardian In Absence Of Father</label>
                                            <div class="col-lg-8 fv-row">
                                                <textarea name="absence_of_father" id="absence_of_father"
                                                    class="form-control form-control-lg form-control-solid"
                                                    placeholder="Name And Relationship Of Guardian In Absence Of Father" /></textarea>
                                                <br>
                                                <span class="text-danger" id="name-error"></span>
                                            </div>
                                        </div>
                                        <div class="row mb-6">
                                            <label class="col-lg-4 col-form-label  fw-semibold fs-6">Freedom Fighter
                                                Quota Or
                                                Others Quota</label>
                                            <div class="col-lg-8 fv-row">
                                                <textarea name="quota" id="present_address"
                                                    class="form-control form-control-lg form-control-solid"
                                                    placeholder="Type yes or no" /></textarea>
                                                <br>
                                                <span class="text-danger" id="name-error"></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <select name="mandatory_subject" id="mandatory_subject"
                                                    aria-label="Select a  Mandatory Subject" data-control="select2"
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                ...
                                                <select name="optional_subject" id="optional_subject"
                                                    aria-label="Select a Group" data-control="select2"
                                    ...
                                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                                        <a href="https://www.csbmc.edu.bd/admin/students"
        ...
        <div class="footer py-4 d-flex flex-lg-column noPrint" id="kt_footer">
            ...
            <div class="container-xxl d-flex flex-column flex-md-row align-items-center justify-content-between">
                ...
                <div class="text-dark order-2 order-md-1">
                    ...
                    <a href="https://ihealthscreen.org/" target="_blank"
                        class="text-gray-800 text-hover-primary">iHealthScreen Bangladesh</a>
                </div>
                <!--end::Copyright-->
                <!--begin::Menu-->
...
<script src="https://cdn.amcharts.com/lib/5/themes/Animated.js"></script> -->
    ...
    <link href="https://www.csbmc.edu.bd/assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet"
        type="text/css" />
    <script src="https://www.csbmc.edu.bd/assets/plugins/custom/datatables/datatables.bundle.js"></script>

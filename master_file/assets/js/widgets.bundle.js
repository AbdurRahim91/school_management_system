                ...
                if (e) {
                    var t, a = function() {
                        ...
                        p.mapPolygons.template.events.on("click", (function(e) {
                            ...
                            for (var t = e.target.dataItem.dataContext.id.split("-").pop(), a = r(l[t]), o = 0; o < a.length; o++)
...
var KTTimelineWidget24 = {
    init: function() {
        ...
        (e = document.querySelector("#kt_list_widget_24")) && KTUtil.on(e, '[data-kt-element="follow"]', "click", (function(e) {
            "Following" === this.innerText ? (this.innerText = "Follow",
            this.classList.add("btn-light-primary"),
            this.classList.remove("btn-primary"),
            this.blur()) : (this.innerText = "Following",
...
var KTPlayersWidget1 = {
    init: function() {
        KTUtil.on(document.body, '[data-kt-element="list-play-button"]', "click", (function(e) {
            ...
            r.classList.contains("d-none") ? (a.play(),
            l.classList.add("d-none"),
            r.classList.remove("d-none")) : (a.pause(),
    ...
    var e = function() {
        ...
        if (e) {
            ...
            t.addEventListener("timeupdate", (function() {
                ...
                this.ended && (i.classList.remove("d-none"),
                s.classList.add("d-none"))
            }
            )),
            o.addEventListener("click", (function() {
                t.duration > 0 && !t.paused ? (t.pause(),
                i.classList.remove("d-none"),
                s.classList.add("d-none")) : t.readyState >= 2 && (t.play(),
                i.classList.add("d-none"),
                s.classList.remove("d-none"))
            }
            )),
            n.addEventListener("click", (function() {
                t.readyState >= 2 && (t.currentTime = 0,
                t.play(),
                i.classList.add("d-none"),
                s.classList.remove("d-none"))
            }
      ...
      , b = function(e, t, a, l, r) {
        ...
        if (o) {
            var i = parseInt(KTUtil.css(o, "height"))
              ...
              , n = (KTUtil.getCssVariableValue("--kt-gray-800"),
    ...
    const l = ()=>{
        ...
        e.forEach(((e,a)=>{
            e.addEventListener("click", (l=>{
                ...
                if (o.classList.contains("isOpen")) {
                    for (; o.nextSibling && "subtable_template" === o.nextSibling.getAttribute("data-kt-table-widget-4"); )
      ...
      , s = ()=>{
        ...
        e.querySelectorAll("tbody tr").forEach((e=>{
            ...
            e.querySelector('[data-kt-table-widget-4="expand_row"]') && e.querySelector('[data-kt-table-widget-4="expand_row"]').classList.remove("active")
        }
        ))
    }
    ;
...
var KTTimelineWidget2 = {
    init: function() {
        ...
        (e = document.querySelector("#kt_timeline_widget_2_card")) && KTUtil.on(e, '[data-kt-element="checkbox"]', "change", (function(e) {
            ...
            !0 === this.checked ? (t.classList.add("form-check-success"),
